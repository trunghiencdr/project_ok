...
public class NewJPanel extends javax.swing.JPanel {
    ...
    String chieuDi;
    public NewJPanel(String maTau,String maToa,String thoiGianDi,String thoiGianDen,DefaultTableModel model, String chieuDi) {
        initComponents();
        this.model=model;
        this.maTau=maTau;
        this.maToa=maToa;
    ...
    public JToggleButton getJToggleButtonByText(String textOfButton)
    {
        ...
        {
            if (i.getText().equals(textOfButton)) return i;
        }
        return null;
    }
